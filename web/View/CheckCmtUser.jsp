<%-- 
    Document   : CheckCmtUser
    Created on : Nov 18, 2020, 4:37:15 AM
    Author     : Doktoh
--%>
                ...
                <div class="header_resize">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/editnew"><span>Sửa tin</span></a></li>
                            <li><a href="${pageContext.request.contextPath}/checkcmt" class="active"><span>Comment</span></a></li>
                        </ul>
                    </div>
                    <div class="clr"></div>
                </div>
            ...
            <div class="body">
                <div class="body_resize">
                    <div class="left">
                        <div class="item">
                            <h2>Sửa tin</h2>
                            <form action="checkcmt" method="get" enctype="multipart/form-data" id="contactform">
                                <table>
                                    <tr>
                                        <td>
                                            <label>Tên tin*</label>
                                    ...
                                    <%
                                        ...
                                        if (request.getAttribute("listcmt") != null) {
                                            ...
                                            for (Comment item : listcmt) {
                                                ...
                                                out.println("<hr>");
                                                out.println("<tr><td></td><td><a href=\"checkcmt?id=" + item.getId() + "&name="+request.getParameter("name")+"&load=Load\">Duyệt</a></td></tr></table>");
