<%-- 
    Document   : DelCatView
    Created on : Nov 16, 2020, 4:42:45 AM
    Author     : Doktoh
--%>
            ...
            <div class="body">
                <div class="body_resize">
                    <div class="left">
                        <div class="item">
                            <h2>Sửa Category</h2>
                            <form action="delcat" method="get" enctype="multipart/form-data" id="contactform">
                                <ol>
                                    <li>
                                        <label>Danh mục</label><br><br>
                                            <%
                                                ...
                                                for (Category item : listc) {
                                                    ...
                                                    %>
                                                    <a href="delcat?id=<%out.println(item.getId());%>"><span>Xóa</span></a>
                                                    <%
                                                }
                                            %>
                                    </li>
